...
public class NumberPicker extends LinearLayout {
	...
	protected void onDraw(Canvas canvas) {
		...
		float y = mCurrentScrollOffset; // + ((int)(getMeasuredHeight() *  PADDING));
		...
		for (int selectorIndex : selectorIndices) {
			...
			canvas.drawText(scrollSelectorValue, x, y - ((int) (getMeasuredHeight() * PADDING * 6)), mSelectorWheelPaint);
	...
	private void initializeSelectorWheel() {
		...
		mInitialScrollOffset = editTextTextPosition - (mSelectorElementHeight * SELECTOR_MIDDLE_ITEM_INDEX) + ((int) (getMeasuredHeight() * PADDING));
		mCurrentScrollOffset = mInitialScrollOffset;
		updateInputTextView();
	}
